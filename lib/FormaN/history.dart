...
import 'formaNFromReestrNew.dart';
...
class _formaNFishPageScreenState extends State<historyPage> {
  ...
  @override
  void initState() {
    historyList = formFromRestr['NForm']['flights'][whatRoutShow]['agreement_signs'];
                            ...
                            children:[
                              ...
                              Row(
                                children:[
                                  ...
                                  //SizedBox(width: 10,),
                                  Expanded( child:Text(
                                    '${formFromRestr['NForm']['flights'][whatRoutShow]['flight_information']['flight_num']} - ${formFromRestr['NForm']['flights'][whatRoutShow]['main_date']['date']}',
                                    style: TextStyle(fontSize: 16,fontFamily: 'AlS Hauss',),
                                  )),
                                  SizedBox(width: 10,),
                                  //Spacer(),
                                 Text(
                                    '${historyList[index]['result_rus']}',
                                    style: TextStyle(fontSize: 14,fontFamily: 'AlS Hauss',color: historyList[index]['result_rus'] == 'Отклонено' ? Color(0xFFFF5A43) : historyList[index]['result_rus'] == 'Утверждено' ? Color(0xFF00FF2C) : historyList[index]['result_rus'] == 'Принято' ? Color(0xFFCF9400) :historyList[index]['result_rus'] == 'Запрос информации' ? Color(0xFF337AD9) : kWhite),
                                  ),
                                ]
                              ),
                              SizedBox(height: 5,),
                              Container(
                                  ...
                                  child:Row(
                                      children: [
                                        Expanded( child:Text(
                                          '${formFromRestr['NForm']['flights'][whatRoutShow]['flight_information']['departure_airport_icao'].substring(0, formFromRestr['NForm']['flights'][whatRoutShow]['flight_information']['departure_airport_icao'].length > 4 ? 4 : formFromRestr['NForm']['flights'][whatRoutShow]['flight_information']['departure_airport_icao'].length)} → ${formFromRestr['NForm']['flights'][whatRoutShow]['flight_information']['landing_airport_icao'] != null ? formFromRestr['NForm']['flights'][whatRoutShow]['flight_information']['landing_airport_icao'].substring(0,formFromRestr['NForm']['flights'][whatRoutShow]['flight_information']['landing_airport_icao'].length > 4 ? 4 : formFromRestr['NForm']['flights'][whatRoutShow]['flight_information']['landing_airport_icao'].length) : ''} ${formFromRestr['NForm']['flights'][whatRoutShow]['flight_information']['landing_time'] != null ? formFromRestr['NForm']['flights'][whatRoutShow]['flight_information']['landing_time'].substring(0,5) : ''}',
                                          style: st14, textAlign: TextAlign.left,
                                        )),
                                        SizedBox(width: 10,),
                                        Text(
                                          '${historyList[index]['role_id']}',
                                          style: st14,
                                        ),
                                      ])),
                              SizedBox(height: 5,),
